...
const registerUser = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (avatar) {
            await deletFromCloudinary(avatar.public_id)
        }
        if (coverImage) {
            await deletFromCloudinary(coverImage.public_id)
        }
...
const getWatchHistory = asyncHandler( async (req, res) => {
    ...
    return res.status(200).json( new ApiResponse(200, user[0]?.wathchHistory, "Watch history fetched successfully"))
})
